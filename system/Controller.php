...
class Controller{
	...
	public function filterParams($params, $input) {
    ...
    public function checkAuthToken(){
        ...
        if($_tokens != '0mtep2j3smey6g9w6hvqzopva'){
	...
	protected function inputValidate(){
	...
	protected function postValidate($session = false){
